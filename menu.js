...
const foodArr = [
  {
    ...
    popularity: 2,
    rating: 2,
    tags: ["gluten-free", "peppers", "variety"],
  },
  {
...
// I assumed there was a typo for the "below" condition
const filterByProperty = (property, number, type) => {
  let filteredArray = [];

  if (type === "above") {
    filteredArray = foodArr.filter((pizza) => pizza[property] > number);
  } else if (type === "below") {
    filteredArray = foodArr.filter((pizza) => pizza[property] < number);
  }
...
// console.log(filterByProperty("price", 11.99, "above"));
