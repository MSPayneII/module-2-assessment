...
// console.log(canWeDeliver(48139));
...
const canWeDeliverTwo = (zipCode) => {
  // .find() returns the value of the first element in the deliveryAreaZipCodes array that matches the zipCode input variable. If zipCode doesn't match one in the deliveryAreaZipCodes array, undefined is returned.

  let zipCheck = deliveryAreaZipCodes.find((arrayZip) => arrayZip === zipCode);
...
console.log(canWeDeliverTwo(48139));
...
//CODE HERE
let firstDealTitle = deals[0]["title"];
deals[0]["title"] = firstDealTitle.replace("15", "10");
console.log(deals);
...
//CODE HERE
let secondDealDesc = deals[1]["desc"];
deals[1]["desc"] = secondDealDesc.replace("March", "April").trim();
